...
class ProductionBenchmarker:
    ...
    def _poll_status(self, record_id, headers):
        poll_url = f'{API_BASE}/ocr-staging/'
        attempts = 0
        while attempts < 30:
            try:
