...
from vendors.po_pdf_service import generate_po_pdf
...
pdf_bytes = generate_po_pdf(sample_po, sample_company)
print(f"Generated PDF successfully! Size: {len(pdf_bytes)} bytes")

out_path = os.path.join(os.path.dirname(__file__), 'sample_po.pdf')
with open(out_path, 'wb') as f:
    f.write(pdf_bytes)
print(f"Written sample PDF to {out_path}")
