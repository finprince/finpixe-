                    ...
                    {isExtracting && masterResults.length === 0 ? (
                        <div className="flex-1 flex flex-col items-center justify-center p-12 text-center">
                            <div className="w-20 h-20 bg-[#EEF2FF] rounded-full flex items-center justify-center mb-6">
                                <Icon name="spinner" className="w-10 h-10 text-[#6366F1] animate-spin" />
                            </div>
                            ...
                            <div className="mt-8 flex gap-2 justify-center">
                                ...
                                <span className="w-2 h-2 bg-[#6366F1] rounded-full animate-bounce delay-75"></span>
                                <span className="w-2 h-2 bg-[#6366F1] rounded-full animate-bounce delay-150"></span>
                            </div>
                        </div>
                    ) : (
                        <>
                                ...
                                <div className="mb-6 flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        <button
                                            ...
                                            className={`inline-flex items-center px-6 py-3 border border-transparent text-sm font-medium rounded-[4px] text-white ${isExtracting ? 'bg-gray-400 cursor-not-allowed' : 'bg-[#6366F1] hover:bg-[#4F46E5]'}`}
                                        >
                                            <Icon
                            ...
                            {masterResults.length > 0 ? (
                                ...
                                <div className="flex-1 flex flex-col items-center justify-center border-2 border-dashed border-slate-200 rounded-lg bg-slate-50 p-12 text-center">
                                    ...
                                    <button
                                        onClick={() => fileInputRef.current?.click()}
                                        className="mt-6 inline-flex items-center px-6 py-3 border border-transparent text-sm font-medium rounded-[4px] text-white bg-[#6366F1] hover:bg-[#4F46E5]"
                                    >
