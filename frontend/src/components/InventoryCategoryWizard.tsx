        ...
        return nodes.map((node) => {
            ...
            return (
                <div key={node.id} style={{ marginLeft: `${node.level * 20}px` }}>
                    <div
                        className={`flex items-center py-1.5 px-2 cursor-pointer hover:bg-gray-100 rounded transition-colors ${isSelected ? 'bg-[#EEF2FF] text-slate-700 font-medium border-l-2 border-[#6366F1]' : ''}`}
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            {(showChangeParent && selectedNode.level > 0 && allowCreateGroup) && (
                                                <button
                                                    ...
                                                    className="text-[#6366F1] hover:text-[#4F46E5] text-xs font-medium tracking-wide uppercase"
                                                >
                                                    Change Parent
                                                </button>
                                            )}
                                    ...
                                    <div>
                                        ...
                                        {selectedNode && selectedNode.level === 0 ? (
                                            ...
                                            <input
                                                ...
                                                className={`w-full px-3 py-2 border rounded focus:outline-none transition-all text-sm ${!allowCreateGroup ? 'border-gray-200 bg-gray-50 text-gray-400 cursor-not-allowed' : 'border-gray-300 focus:border-[#6366F1] focus:ring-1 focus:ring-[#6366F1] placeholder-gray-400 bg-white text-gray-800'}`}
                                            ...
                                            <div className="flex items-center justify-between">
                                                {isEditing ? (
                                                    <input
                                                        ...
                                                        value={formData.group}
                                                        onChange={handleInputChange}
                                                        className="w-full px-3 py-2 border border-[#6366F1] rounded focus:border-[#6366F1] focus:ring-1 focus:ring-[#6366F1] outline-none transition-all placeholder-gray-400 bg-white text-gray-800 text-sm"
                                    ...
                                    <div>
                                        ...
                                        {!selectedNode.data.id ? (
                                            ...
                                            <input
                                                ...
                                                className={`w-full px-3 py-2 border border-gray-300 rounded focus:border-[#6366F1] focus:ring-1 focus:ring-[#6366F1] outline-none transition-all placeholder-gray-400 text-sm ${!selectedNode || selectedNode.level > 1
                                ...
                                {selectedNode && selectedNode.data.id && !isEditing ? (
                                    <div className="flex gap-3">
                                        <button
                                            ...
                                            className="flex-1 py-2.5 px-4 rounded font-medium transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 text-sm bg-[#6366F1] text-white hover:bg-[#4F46E5] cursor-pointer focus:ring-[#6366F1]"
                                        >
                                    ...
                                    <button
                                        ...
                                        className={`w-full py-2.5 px-4 rounded font-medium transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 text-sm ${selectedNode && (
                                            ...
                                            ? 'bg-[#6366F1] text-white hover:bg-[#4F46E5] cursor-pointer focus:ring-[#6366F1]'
                                            : selectedNode
