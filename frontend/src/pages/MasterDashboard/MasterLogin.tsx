...
const MasterLoginPage: React.FC<MasterLoginPageProps> = ({ onLogin }) => {
    ...
    return (        <div className="min-h-screen w-full flex bg-[#FFF9F4] overflow-hidden text-slate-900 font-sans">
                ...
                <div className="w-full max-w-md space-y-8 text-left">
                        ...
                        <form className="space-y-5" onSubmit={handleSubmit} noValidate>
                            ...
                            {view === 'otp' && (
                                <div className="space-y-4">
                                    <div className="text-center p-4 bg-slate-50 rounded-2xl border border-slate-200">
                                        <KeyRound className="w-8 h-8 text-[#F97316] mx-auto mb-2" />
                                        ...
                                        <>
                                            ...
                                            <div className="space-y-1.5 w-full">
                                                ...
                                                <div className="relative flex items-center w-full">
                                                    ...
                                                    <button
                                                        type="button"
                                                        className="absolute right-3.5 text-slate-400 hover:text-[#F97316] transition-colors"
                                                        onClick={() => setShowPassword(!showPassword)}
                                                    >
                                                        <Icon name={showPassword ? "eye-off" : "eye"} size={16} />
                                                    </button>
                            ...
                            {view === 'forgot' && (
                                <button
                                    ...
                                    className="w-full text-center text-[10px] font-bold text-slate-400 uppercase tracking-widest hover:text-[#F97316] transition-colors mt-3"
                                >
                                    Return to Login
                                </button>
                            )}
                    ...
                    <div className="pt-6 border-t border-slate-100 flex flex-col gap-3">
                        <button
                            ...
                            className="w-full h-12 rounded-xl bg-slate-50 border border-slate-200 text-xs font-bold text-slate-600 uppercase tracking-widest hover:bg-slate-100 hover:text-orange-600 transition-all flex items-center justify-center gap-2"
                        >
