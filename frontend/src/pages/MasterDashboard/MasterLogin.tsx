        ...
        <PremiumBackground>
            <div className="z-10 w-full max-w-[440px] flex flex-col items-center animate-in fade-in zoom-in-[0.98] duration-700">
                ...
                <div className="w-full rounded-[16px] border border-white/15 bg-[#FFF6EE]/92 backdrop-blur-xl shadow-[0_12px_32px_rgba(15,23,42,0.08)] sm:shadow-[0_24px_64px_rgba(15,23,42,0.10)] overflow-hidden">
                    <div className="p-7 w-full flex flex-col items-start transition-all duration-300">
                        {/* Domain badge */}
                        <div className="flex items-center gap-2 px-2.5 py-1 bg-orange-50 border border-orange-100 rounded-lg mb-5 w-fit">
                            ...
                            <span className="text-[8px] font-black text-[#F97316] uppercase tracking-widest">
                        ...
                        {view === 'success' ? (
                            <div className="w-full text-center space-y-4 py-4 animate-in fade-in slide-in-from-bottom-2">
                                ...
                                <button
                                    ...
                                    className="mt-6 w-full h-[46px] bg-slate-100 text-[#F97316] rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-200 transition-all"
                                >
                                    Back to Login
                                </button>
                            </div>
                            ...
                            <form className="w-full space-y-4 text-left animate-in fade-in" onSubmit={handleSubmit}>
                                ...
                                {view === 'otp' && (
                                    <>
                                        <div className="text-center mb-6">
                                            <div className="w-12 h-12 bg-orange-50 text-[#F97316] rounded-full flex items-center justify-center mx-auto mb-4">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <input
                                                ...
                                                type="text"
                                                maxLength={6}
                                                className="w-full h-[42px] bg-[#FFF9F4] border border-orange-100 rounded-xl px-3.5 text-center tracking-[0.5em] text-lg font-black text-slate-900 placeholder:text-slate-300 focus:outline-none focus:border-[#F97316] transition-all"
                                                placeholder="••••••"
                                                value={otp}
                                        ...
                                        <div className="space-y-1 mt-4">
                                            ...
                                            <div className="relative">
                                                <input
                                                    ...
                                                    className="w-full h-[42px] bg-[#FFF9F4] border border-orange-100 rounded-xl px-3.5 text-xs font-bold text-slate-900 placeholder:text-slate-300 focus:outline-none focus:border-[#F97316] transition-all pr-10"
                                                    placeholder="••••••••"
                                                    value={newPassword}
                                                ...
                                                <button
                                                    type="button"
                                                    className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-300 hover:text-[#F97316] transition-colors"
                                ...
                                {(view === 'login' || view === 'forgot') && (
                                    <>
                                        ...
                                        id="master-email"
                                        type="email"
                                        className="w-full h-[42px] bg-[#FFF9F4] border border-orange-100 rounded-xl px-3.5 text-xs font-bold text-slate-900 placeholder:text-slate-300 focus:outline-none focus:border-[#F97316] transition-all"
                                        ...
                                        <div className="space-y-1 animate-in fade-in slide-in-from-top-1">
                                            <div className="flex justify-between items-center ml-0.5">
                                                ...
                                                <button 
                                                    ...
                                                    className="text-[8px] font-bold text-[#F97316] uppercase tracking-widest hover:underline"
                                                >
                                                    Forgot?
                                                </button>
                                            </div>
                                ...
                                <div className="pt-2">
                                    <button
                                        ...
                                        className="w-full h-[46px] bg-[#F97316] text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-[#EA580C] transition-all shadow-[0_8px_16px_rgba(249,115,22,0.25)] disabled:opacity-50"
                                    >
                                ...
                                {view === 'forgot' && (
                                    <button 
                                        ...
                                        className="w-full text-center mt-3 text-[9px] font-bold text-slate-400 uppercase tracking-widest hover:text-[#F97316] transition-colors"
                                    >
                                        Return to Login
                                    </button>
                                )}
                        ...
                        <footer className="w-full pt-1 mt-3 border-t border-slate-100">
                            <button 
                                ...
                                className="w-full py-3 rounded-xl bg-slate-50 border border-slate-100 text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] hover:bg-slate-100 hover:text-[#F97316] transition-all flex items-center justify-center gap-2 mt-2"
                            >
