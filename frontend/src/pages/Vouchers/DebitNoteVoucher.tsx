                                    ...
                                    {selectedSupplierInvoices.length > 0 && (
                                        <div className="flex flex-wrap gap-2 mt-2">
                                            {selectedSupplierInvoices.map((no, idx) => {
                                                const colors = ['bg-blue-100 text-blue-700 border-blue-200', 'bg-green-100 text-green-700 border-green-200', 'bg-purple-100 text-purple-700 border-purple-200', 'bg-indigo-100 text-indigo-700 border-indigo-200'];
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-gray-200">
                            ...
                            <div className="md:col-span-1">
                                <div className="flex justify-between items-center mb-4">
                                    ...
                                    <label className="flex items-center text-xs font-bold text-[#6366F1] cursor-pointer uppercase tracking-tight">
                                        <input
                                            type="checkbox"
                    ...
                    <div className="space-y-6">
                        <div className="overflow-x-auto border border-gray-200 rounded-[4px]">
                            <table className="w-full text-sm text-left text-gray-500 whitespace-nowrap min-w-[1200px]">
                                <thead className="bg-[#6366F1] text-white uppercase font-semibold">
                                    <tr>
                ...
                {activeTab === 'payment' && (
                    <div className="space-y-6">
                        ...
                        <div className="border border-gray-300 rounded-[4px] overflow-hidden">
                            <table className="w-full">
                                <thead className="bg-[#6366F1] text-white uppercase">
                                    <tr>
